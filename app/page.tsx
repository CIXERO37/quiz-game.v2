...
import { Play, Users, Gamepad2, QrCode } from "lucide-react"
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    if (codeParam) {
      setGameCodeFromUrl(codeParam.toUpperCase())
    ...
    <>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#87CEEB] to-[#98D8E8]">
          ...
          <div className="absolute bottom-0 w-full h-1/3 bg-[#8B4513]" style={{ imageRendering: "pixelated" }}>
            ...
            <div className="absolute bottom-8 left-1/4">
              ...
              <div
                className="absolute -top-8 -left-4 w-12 h-12 bg-[#006400]"
            ...
            <div className="absolute bottom-8 right-1/4">
              ...
              <div
                className="absolute -top-10 -left-5 w-14 h-14 bg-[#006400]"
                style={{ imageRendering: "pixelated" }}
              ></div>
            </div>
          </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col justify-center items-center">
        ...
        >
          ...
          >
            <div
              className="w-24 h-24 mx-auto bg-white/20 backdrop-blur-lg rounded-2xl flex items-center justify-center mb-4 border-4 border-white/30"
              style={{ imageRendering: "pixelated" }}
            >
        ...
        >
          <motion.div whileHover={{ scale: 1.05, y: -10 }} whileTap={{ scale: 0.95 }} className="group">
            ...
            >
              <div
                className="w-16 h-16 bg-[#FFD93D] border-2 border-[#FFC107] rounded-md flex items-center justify-center group-hover:rotate-12 transition-transform duration-300"
                style={{ imageRendering: "pixelated" }}
              >
