...
export default function HostPage() {
  ...
  const updatePlayerProgress = useCallback(async () => {
    ...
    if (!error && answers) {
      ...
      const sudahAdaYangSelesai = Array.from(progressMap.values()).some((p) => p.currentQuestion >= quiz.questionCount)
          ...
          <div className="flex items-end justify-center gap-4 md:gap-8">
            ...
            >
              ...
              >
                ...
                <div className="absolute -top-3 -right-3 w-10 h-10 md:w-12 md:h-12 bg-gray-400 rounded-full flex items-center justify-center text-xl md:text-2xl">
                  🥈
                </div>
              </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="absolute -top-4 -right-4 w-12 h-12 md:w-16 md:h-16 bg-yellow-400 rounded-full flex items-center justify-center text-2xl md:text-3xl">
                  🥇
                </div>
              </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="absolute -top-3 -right-3 w-10 h-10 md:w-12 md:h-12 bg-orange-500 rounded-full flex items-center justify-center text-xl md:text-2xl">
                  🥉
                </div>
              </motion.div>
